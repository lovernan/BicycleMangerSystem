...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <xblock>
            <button class="layui-btn" onclick="type_add('添加车辆类型','admin/type_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
            ...
            <table class="layui-table">
                ...
                <tbody id="x-link">
                	<c:forEach items="${pageBean.allList }" var="typemain">
	                    <tr>	                    	
	                    	<td>${typemain.id }</td>
							<td>${typemain.type } </td>                        
	                         <td class="td-manage">
	                            <a title="编辑" href="javascript:;" onclick="ys_edit('编辑','admin/type_edit.jsp','4','','510')"
