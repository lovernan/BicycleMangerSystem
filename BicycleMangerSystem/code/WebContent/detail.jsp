	...
	<div class="container">
		...
		<jsp:include page="/header.jsp"></jsp:include>
			...
			<div class="panel panel-default" style="margin-top: 10px">
				<div class="panel-heading" style="font-size: 25px">${rentSearch.name }</div>
				<div class="panel-body">
					<p>${rentSearch.information }</p>
					<img style="width: 400px; height: 300px" src="${rentSearch.image }">
					<p style="text-indent: 40em;">联系方式：${rentSearch.tel }</p>
				</div>
			<div>
			<table>
				<tr class="tr" id="tabletr">
					<td style="display:none;">${rentSearch.id}</td>
					<td style="display:none;">${rentSearch.name}</td>
