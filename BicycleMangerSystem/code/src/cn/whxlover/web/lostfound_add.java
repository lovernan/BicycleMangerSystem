...
public class lostfound_add extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			BeanUtils.populate(lostfound, map);
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		// 传数据到service层
		addSer lostfound_addSer = new addSer();
		int issuccess = 0;
		try {
			issuccess = lostfound_addSer.lostfound_add(lostfound);
		...
		response.sendRedirect("lostfoundlist");
