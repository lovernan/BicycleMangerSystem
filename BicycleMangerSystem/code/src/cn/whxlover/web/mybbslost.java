...
public class mybbslost extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			lostfound = showrent.mybbslostSer(currentpage,currentcount,username);
		...
		request.getRequestDispatcher("/mybbs2.jsp").forward(request, response);
